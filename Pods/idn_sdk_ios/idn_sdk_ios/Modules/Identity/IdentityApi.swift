...
open class IdentityApi : NetworkApi {
    ...
    open func accountKitLogin(_ loginDetails : Dictionary<String, Any>, responseHandler: @escaping (NewMemberApiModel?, MessagesApiModel?, NSError?) -> ()){
        ...
        remoteAPI.accountKitLogin(loginDetails: loginDetails, completionHandler: {
            responseObject,statusCode, error in
